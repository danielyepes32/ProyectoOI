...
export default function VariationBar({
    ...
    return(
        <div className="w-full border shadow-lg flex h-auto rounded-[25px] bg-white p-2">
          <div className="w-1/4 flex-col flex justify-center place-items-center">
            <div className="flex-col justify-center items-center flex place-items-center space-y-2">
          ...
          <div className="w-1/4 flex-col flex items-center justify-center place-items-center space-y-2">
            <div className="w-full h-auto flex flex-col leading-none">
              <span className="text-center w-full font-inter">Var</span>
              <span className="text-center w-full font-inter"> (%) </span>
            </div>
          ...
          <div className="w-1/3 justify-center flex flex-col items-center place-items-center space-y-2">
            <div className="w-full h-auto flex flex-col leading-none">
              <span className="text-center w-full font-inter">Var</span>
              <span className="text-center w-full font-inter"> (%) </span>
            </div>
