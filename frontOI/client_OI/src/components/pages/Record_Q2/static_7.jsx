...
export default function static_7_Q2() {
  ...
  , []);
        ...
        prevMeters.map(({ meter_id, q2, ...rest }) =>
          meter_id === key
            ? {
                ...rest,
                meter_id,
                q2: { ...q2, record_lf: Number(newValue) }, // Actualiza solo record_li
              }
    ...
    const handleUpdateMeter = async (medidores) => {
      ...
      const puedeAvanzar = parseInt(count_secuencia) === 6; 
      ...
      localStorage.setItem("count_secuencia", "7")
