...
export default function Static_6_Q2() {
  ...
  , []);
    ...
    const handleUpdateMeter = async (medidores) => {
      ...
      const puedeAvanzar = parseInt(count_secuencia) === 4; 
      ...
      localStorage.setItem("count_secuencia", "5");
    ...
    const confirmationMessage = React.useMemo(() => {
        ...
        return isOpenCustomMessage === true ? (
          <CustomAlert 
            ...
            routeRedirect={"/client/Q2/static_6_5"}
