    ...
    const updateResult = (key, newValue) => {
      setMeters((prevMeters) => 
        prevMeters.map((meter) => 
          meter.meter_id === key
            ? { ...meter, record_lf: newValue} // Actualiza solo el que coincide
      ...
      case "record_lf":
        ...
        return (
          <Input 
            ...
            value={pointerMeter.record_lf === null ? '' : pointerMeter.record_lf}
            variant = "underlined"
            ...
            color={pointerMeter.record_lf === '' ? "danger" : pointerMeter.record_lf ? "primary" : "danger"} //Aquí hay un error, el isInbvalid debe actualizarse por fuera de este reenderizado para funcionar porque los sets no actualizan hasta el proximo reanderizado, pero por ahora no tengo tiempo :P
            onValueChange={(value)=>{
